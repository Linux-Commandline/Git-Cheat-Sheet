...
The git command-line utility has plenty of inconsistencies, A GUI like http://sourcetreeapp.com is often helpful, but staying on the command line usually quicker.
